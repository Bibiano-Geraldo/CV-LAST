...
const SAMPLE_CV = {
  ...
  website: "aicha.work",
  photo: null, // placeholder slot
  summary: "Designer de produto com 8 anos a desenhar sistemas financeiros e ferramentas internas. Especialista em traduzir investigação em interfaces que reduzem fricção em fluxos complexos. Lidero por exemplo — entrego, documento e instalo nas equipas.",
  skills: [
  ...
  // Page 2 content — second experience block, extras
  extras: {
    awards: [
...
const SAMPLE_THREAD = [
  {
    role: "ai",
    body: "Olá Aïcha. Encontrei o anúncio que partilhaste — *Lead Product Designer* na Linear, equipa de plataforma. Vou começar a adaptar o teu currículo agora e digo-te onde precisamos de te focar.",
    meta: "há 4 minutos"
  },
  {
    role: "user",
  ...
  {
    role: "ai",
    body: "Feito. Reescrevi o bullet do Compass para liderar com **impacto** (84 componentes, 6 produtos) e movi-o para o topo da experiência. Também tirei a entrada da Whitesmith — para uma vaga sénior fica a poluir.",
    actions: [
  ...
  {
    role: "ai",
    body: "Sim — sugiro um bullet curto em *Projects*: «Folio kit — design system open-source escrito em React + TypeScript, usado por 9 startups». Posso adicionar?",
    suggestions: ["Adiciona", "Reformula mais curto", "Não, deixa estar"]
  },
];

Object.assign(window, { SAMPLE_CV, RECENT_CHATS, QUICK_PROMPTS, SAMPLE_THREAD });
